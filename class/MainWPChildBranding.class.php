	...
	public function update_branding() {		
		...
		function update_footer()
		{
			...
			<div id="mainwp-branding-contact-support-box" title="Contact support" style="display: none; text-align: center">				
				...
				<div class="mainwp_info-box-yellow" id="mainwp_branding_contact_ajax_message_zone" style="display: none;"></div>
				<p><?php echo get_option('mainwp_branding_support_message'); ?></p>				
				<textarea id="mainwp_branding_contact_message_content" name="mainwp_branding_contact_message_content" cols="69" rows="5" class="text"></textarea>
				</div>
				<input id="mainwp-branding-contact-support-submit" type="button" name="submit" value="Submit" class="button-primary button" />
			</div>
			<script>			
				...
				{					
					jQuery('#mainwp-branding-contact-support-box').dialog({
						...
						width: 500,
						modal: true,
						close: function(event, ui) {jQuery('#mainwp-branding-contact-support-box').dialog('destroy'); location.href = location.href;}});					
				};						
